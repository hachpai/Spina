...
module Spina
  module Pages
    class MenuPresenter
      ...
      config_accessor :list_tag, :list_class, :li, :list_wrapper, :list_item_tag, :list_item_css, :selected_css, :current_css, :first_css, :last_css, :list_tag_with_child_css, :list_item_with_child_css,:link_css
      ...
      def render_menu_item(menu_item, index, menu_items_length)
        content_tag(list_item_tag, class: menu_item_css(menu_item[0], index, menu_items_length, !menu_item[1].empty?)) do
          ...
          buffer << link_to(menu_item[0].menu_title, menu_item[0].full_materialized_path, class:link_css)
